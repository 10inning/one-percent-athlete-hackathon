...
class ChatbotService:
    ...
    def _get_system_prompt(self, mode: ChatbotMode, user_profile: UserProfile) -> str:
        ...
        base_prompts = {
            ChatbotMode.NUTRITION: """You are a nutrition expert helping Athletes with their diet and meal planning Give Short Answers (100 Words).
            ...
            ChatbotMode.FITNESS: """You are a fitness coach helping Athletes achieve their fitness goals Give Short Answers (100 Words).
        ...
        prompt = base_prompts.get(mode, "You are a helpful assistant. Give Short Answers (100 Words)")
        return prompt.format(
            diet_preference=user_profile.dietPreference or "None",
            allergies=user_profile.allergies or "None",
            health_conditions=user_profile.healthConditions or "None",
            preferred_foods=user_profile.preferredFoods or "None",
            location=user_profile.location or "Unknown",
            weight=user_profile.weight or "Unknown",
            height=user_profile.height or "Unknown",
            target_sport=user_profile.targetSport or "None",
            game_played=user_profile.gamePlayed or "None"
        )
